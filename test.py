...
def get_probs(opt):
    ...
    if opt.model['use_resnet'] == 1:
        test_set = HCCDataset6('{:s}/test{:s}.h5'.format(opt.test['img_dir'], fold_num), data_transform, opt)
    else:
        test_set = HCCDataset6('{:s}/test{:s}.h5'.format(opt.test['img_dir'], fold_num), data_transform)
